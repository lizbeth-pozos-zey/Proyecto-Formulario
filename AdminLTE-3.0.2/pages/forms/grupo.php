              ...
              <form role="form" action="" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputGrupo">GRUPO</label>
                    <input type="Text"  name = "grupo" class="form-control" id="exampleInputGrupo" placeholder="Número de Grupo">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputNombreG">NOMBRE</label>
                    <input type="Text"  name = "nombre" class="form-control" id="exampleInputNombreG" placeholder="Nombre del Grupo">
                  </div>
...
$sql="INSERT INTO datos3(nombre,grupo) VALUES (:nombre,:grupo)";
