              ...
              <form role="form" action="" method="POST" >
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputClaveCarrera">CLAVE</label>
                    <input type="text" name="clave" class="form-control" id="exampleInputClaveCarrera" placeholder="Clave de Carrera">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputNombreCarrera">NOMBRE DE CARRERA</label>
                    <input type="Text"  name="carrera" class="form-control" id="exampleInputNombreCarrera" placeholder="Nombre de Carrera">
                  </div>
...
$sql="INSERT INTO datos2(clave,carrera) VALUES (:clave,:carrera)";
