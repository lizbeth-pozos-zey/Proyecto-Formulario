              ...
              <form role="form" action="" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputClave2">CLAVE</label>
                    <input type="number" name = "clave" class="form-control" id="exampleInputClave2" placeholder="Clave de la Materia">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputNombreM">NOMBRE</label>
                    <input type="Text" name = "nombre"class="form-control" id="exampleInputNombreM" placeholder="Nombre de la Materia">
                  </div>
...
$sql="INSERT INTO datos5(clave,nombre) VALUES (:clave,:nombre)";
