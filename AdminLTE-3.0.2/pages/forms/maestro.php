  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CONTROL DE MAESTROS</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">INICIO</a></li>
              <li class="breadcrumb-item active">SISTEMA DE CONTROL-INFORMACIÓN ESCOLAR</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form role="form" action="" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputNumEmpleado">N° EMPLEADO</label>
                    <input type="Text" name = "matricula" class="form-control" id="exampleInputNumEmpleado" placeholder=" Numero de empleado">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputNombreE">NOMBRE</label>
                    <input type="Text" name = "nombre"class="form-control" id="exampleInputNombreE" placeholder="Nombre">
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="number" name = "telefono" class="form-control" id="exampleInputtelefono" placeholder="Telefono">
                  </div>
...
$sql="INSERT INTO datos4(nombre,matricula,correo,telefono) VALUES (:nombre,:matricula,:correo,:telefono)";
...
echo "<div class='content alert alert-primary' > Guardado con exito :  </div>";
}
else{
    echo "<div class='content alert alert-primary' > Guardado con exito :   </div>";
...
?>
            ...
            <!-- Form Element sizes FORMULARIP6 OCULTO
            ...
            <!-- Horizontal Form FORMULARIO OCULTO4
            <div class="card card-info">
              <div class="card-header">
