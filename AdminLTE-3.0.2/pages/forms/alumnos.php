        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <h3 class="card-title">ALUMNNOS</h3> 
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="number" name="matricula" class="form-control" id="exampleInputMatricula" placeholder=" Matricula">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputNombre">NOMBRE</label>
                    <input type="Text" name="nombre" class="form-control" id="exampleInputNombre" placeholder="Nombre">
                  </div>
...
$sql="INSERT INTO datos(nombre,matricula,correo,telefono) VALUES (:nombre,:matricula,:correo,:telefono)";
...
echo "<div class='content alert alert-primary' > Guardado con exito : $nombre  </div>";
}
else{
    echo "<div class='content alert alert-primary' > Guardado con exito : $nombre  </div>";
